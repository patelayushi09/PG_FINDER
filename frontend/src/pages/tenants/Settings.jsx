...
//               />
//               <button className="absolute bottom-0 right-0 bg-[#103538] text-white p-2 rounded-full hover:bg-opacity-90">
//                 <User className="w-4 h-4" />
//               </button>
//             </div>
//             <div>
//               <h3 className="text-lg font-medium text-[#103538]">Alex Johnson</h3>
...
//           Cancel
//         </button>
//         <button className="px-6 py-2 bg-[#103538] text-white rounded-lg hover:bg-opacity-90">
//           Save Changes
//         </button>
//       </div>
//     </div>
