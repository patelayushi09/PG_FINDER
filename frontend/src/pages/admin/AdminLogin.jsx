...
export const AdminLogin = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden bg-transparent">
      {/* Top Wave Background */}
      ...
      <form onSubmit={submitHandler}>
        <div className="relative bg-white p-12 rounded-3xl shadow-2xl w-full max-w-md z-10 text-center border border-gray-200 backdrop-blur-lg bg-opacity-90">
          ...
          <h2 className="text-3xl font-bold text-[#103538]">Admin Login</h2>
          ...
          <div className="flex items-center justify-between mt-2">
            <div className="text-sm">
              <Link to="/admin/forgot-password" className="font-medium text-[#759B87] hover:text-[#103538]">
                Forgot Password?
              </Link>
            </div>
          </div>

          <button type="submit" className="w-full mt-6 bg-[#103538] text-white py-3 rounded-lg font-semibold hover:bg-[#759B87] transition shadow-lg transform hover:scale-105 hover:shadow-xl">
            Login
          </button>
        </div>
      </form>
